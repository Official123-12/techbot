import { useState, useEffect } from "react";
  ...
  export function Contact() {
    ...
    const contacts = [
      ...
      {
        label: "Email",
        handle: "admin@toxicx.tech",
        description: "Send us an email for detailed inquiries",
        href: "mailto:admin@toxicx.tech",
